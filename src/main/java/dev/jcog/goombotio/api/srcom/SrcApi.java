package dev.jcog.goombotio.api.srcom;

import dev.jcog.goombotio.api.srcom.games.CategoryData;
import dev.jcog.goombotio.api.srcom.games.GameData;
import dev.jcog.goombotio.api.srcom.games.Games;
import dev.jcog.goombotio.api.srcom.games.GamesInterface;
import dev.jcog.goombotio.api.srcom.leaderboard.Leaderboard;
import dev.jcog.goombotio.api.srcom.leaderboard.LeaderboardInterface;
import dev.jcog.goombotio.api.srcom.leaderboard.Run;
import dev.jcog.goombotio.api.srcom.leaderboard.VariablesInput;
