package dev.jcog.goombotio.api.bttv;

import dev.jcog.goombotio.api.bttv.user.Emote;
import dev.jcog.goombotio.api.bttv.user.User;
import dev.jcog.goombotio.api.bttv.user.UserInterface;
