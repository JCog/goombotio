package dev.jcog.goombotio.api.ffz;

import dev.jcog.goombotio.api.ffz.room.Emoticon;
import dev.jcog.goombotio.api.ffz.room.Room;
import dev.jcog.goombotio.api.ffz.room.RoomInterface;
