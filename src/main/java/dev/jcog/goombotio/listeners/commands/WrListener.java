...
import dev.jcog.goombotio.api.srcom.SrcEnums;
...
import static dev.jcog.goombotio.api.srcom.SrcEnums.BugFablesCategory.*;
import static dev.jcog.goombotio.api.srcom.SrcEnums.HmFomtCategory.HM_KAREN_GLITCHED;
import static dev.jcog.goombotio.api.srcom.SrcEnums.HmFomtCategory.HM_KAREN_GLITCHLESS;
import static dev.jcog.goombotio.api.srcom.SrcEnums.OotCategory.OOT_ANY_PERCENT;
import static dev.jcog.goombotio.api.srcom.SrcEnums.OotCategory.OOT_GLITCHLESS_AMQ;
import static dev.jcog.goombotio.api.srcom.SrcEnums.PapeCategory.*;
import static dev.jcog.goombotio.api.srcom.SrcEnums.PapeMemesCategory.*;
import static dev.jcog.goombotio.api.srcom.SrcEnums.SmrpgCategory.SMRPG_NORMAL_RTA_TURBO;
import static dev.jcog.goombotio.api.srcom.SrcEnums.SmsCategory.*;
import static dev.jcog.goombotio.api.srcom.SrcEnums.TtydCategory.*;
