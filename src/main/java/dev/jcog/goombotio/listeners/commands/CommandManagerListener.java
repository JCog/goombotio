...
import dev.jcog.goombotio.database.misc.CommandDb;
import dev.jcog.goombotio.database.misc.CommandDb.CommandItem;
import org.apache.commons.cli.*;
import dev.jcog.goombotio.util.CommonUtils;
import dev.jcog.goombotio.util.TwitchApi;
import dev.jcog.goombotio.util.TwitchUserLevel;

import java.util.Iterator;

import static dev.jcog.goombotio.util.TwitchUserLevel.USER_LEVEL;
