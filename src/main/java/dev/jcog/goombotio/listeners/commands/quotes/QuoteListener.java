package dev.jcog.goombotio.listeners.commands.quotes;
...
import dev.jcog.goombotio.database.misc.QuoteDb;
import dev.jcog.goombotio.listeners.commands.CommandBase;
...
import static dev.jcog.goombotio.database.misc.QuoteDb.QuoteItem;
